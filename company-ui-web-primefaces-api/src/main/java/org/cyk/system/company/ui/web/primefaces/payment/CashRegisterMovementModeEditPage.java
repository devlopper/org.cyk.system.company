...
public class CashRegisterMovementModeEditPage extends AbstractCrudOnePage<CashRegisterMovementMode> implements Serializable {
	...
	@Getter @Setter
	public static class Form extends AbstractFormModel<CashRegisterMovementMode> implements Serializable{
		private static final long serialVersionUID = -4741435164709063863L;
		
		
	}
	
	public static class Adapter extends AbstractBusinessEntityFormOnePage.BusinessEntityFormOnePageListener.Adapter.Default<CashRegisterMovementMode> implements Serializable {
