...
public class CashRegisterMovementTermCollectionListPage extends AbstractCrudManyPage<CashRegisterMovementTermCollection> implements Serializable {
	...
	public static class Adapter extends AbstractBusinessEntityFormManyPage.BusinessEntityFormManyPageListener.Adapter.Default<CashRegisterMovementTermCollection> implements Serializable {
		...
		public Adapter() {
			...
			configuration.addFieldNames(CashRegisterMovementTermCollectionDetails.FIELD_CODE,CashRegisterMovementTermCollectionDetails.FIELD_NAME
					,CashRegisterMovementTermCollectionDetails.FIELD_ITEM_CODE_SEPARATOR,CashRegisterMovementTermCollectionDetails.FIELD_AMOUNT);
		}
