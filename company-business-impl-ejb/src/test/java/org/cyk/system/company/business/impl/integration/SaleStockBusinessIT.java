...
public class SaleStockBusinessIT extends AbstractBusinessIT {
    ...
    private void dropAndTakeInOne(Person person){
    	SaleStockInput saleStockInput = drop(date(2015, 1, 1),person, customer1,"A", "1000", "100", "3", "1100", "168", "1100","1100");
    	taking(date(2015, 1, 2),person, saleStockInput, "3", "1100", "0", "0","0");
    }
    
    private void dropAndTakeInMany(Person person){
    	SaleStockInput saleStockInput = drop(date(2015, 1, 3),person, customer1,"B", "1000", "100", "3", "1100", "168", "1100","1100");
    ...
    private void dropAndTakeInManyWithZeroQuantity(Person person){
    	SaleStockInput saleStockInput = drop(date(2015, 1, 6),person, customer1,"C", "1000", "100", "3", "1100", "168", "1100","1100");
    ...
    private void dropAndTakeInManyWithZeroPayment(Person person){
    	SaleStockInput saleStockInput = drop(date(2015, 1, 10),person, customer1,"D", "1000", "100", "3", "1100", "168", "1100","1100");
    ...
    private void dropManyAndTakeInMany(Person person){
    	SaleStockInput saleStockInput1 = drop(date(2015, 2, 1),person, customer1,"E", "1000", "100", "3", "1100", "168", "1100","1100");
    	taking(date(2015, 2, 2),person, saleStockInput1, "1", "400", "2", "700","700");
    	
    	SaleStockInput saleStockInput2 = drop(date(2015, 2, 3),person, customer1,"F", "1500", "100", "5", "1600", "245", "1600","2300");
