...
public interface AbstractSaleStockBusiness<SALE_STOCK extends SaleStock,SEARCH_CRITERIA extends AbstractSaleStockSearchCriteria> extends TypedBusiness<SALE_STOCK> {
	...
	Collection<SALE_STOCK> findByTangibleProductStockMovements(Collection<StockTangibleProductMovement> tangibleProductStockMovements);
	SALE_STOCK findByTangibleProductStockMovement(StockTangibleProductMovement tangibleProductStockMovement);
